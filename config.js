module.exports = {
    ...
    ownerName: 'Sadeeq',
    ownerNumber: '08123293919', // Your WhatsApp number in international format
    ...
    presenceStatus: 'available', // Default bot presence status (available, typing, recording, invisible)
